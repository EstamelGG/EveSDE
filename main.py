...
def copy_icon_batch():
    ...
    special_file_mapping = {
        ...
        '40362': [32340,40362,45673,45675],  # 槌骨 I
        '40364': [32325,40364],  # 独眼巨人 I
        '41363': [32326,41363],  # 独眼巨人 I
        '41355': [32341,41355],  # 槌骨 I
        ...
        '32342': [32342, 40365],  # 斩裂剑 I
        '32343': [32343, 41365],  # 斩裂剑 I
